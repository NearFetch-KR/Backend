...
from .views      import LikeView, ProductDetailView, ProductListView, MainHotDealView, MainHotItemView, MainRecommendView, MakeCategoryView, MakeFilterView, MakeBrandListView
...
urlpatterns = [
	...
	path('/main/hotdeal', MainHotDealView.as_view()),
